...
public class FactFetcherPlan extends Plan
{
	...
	{	
		...
		Collection services = getAgent().getFeature(IRequiredServicesFeature.class).getLocalServices(new ServiceQuery<>(IBeliefGetter.class, ServiceScope.COMPONENT_ONLY));
