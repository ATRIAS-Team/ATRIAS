package jadex.bdiv3.examples.cleanerworld.learning_module;
...
public class NeuralNetworkUtil {
  ...
  //  public final class ImageClassification {
        ...
        private static final Logger logger = LoggerFactory.getLogger(NeuralNetworkUtil.class);

        private NeuralNetworkUtil() {}

     //   public static void main(String[] args) throws IOException, ModelException, TranslateException {
      //      Classifications classifications = (Classifications) Predictor.predict();
      //     logger.info("{}", classifications);
     //   }

    @PlanBody
    public Classifications body()  throws IOException, ModelException, TranslateException {
