...
public class Job {
    ...
    private String precalculatedVehicle;
    ...
    public String getPrecalculatedVehicle(){return this.precalculatedVehicle;}
    ...
    public static ArrayList<Job> csvToJobs(String csvPath, char delimiter){
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(csvPath))) {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                //create and add job
                Job job = new Job(fields[0], fields[1], bookingTime, vaTime, startLocation, endLocation);
                if (fields.length > 8) {
                    job.precalculatedVehicle = fields[8];
                }
                jobs.add(job);
            }
        } catch (IOException e) {
