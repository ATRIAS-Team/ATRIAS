...
public class Trip {
    ...
    private String tripType; //charging trip, customer trip, ...
    private LocalDateTime vaTime; // vehicle arriving time
    private Location startPosition; // use this for trips with just one Geolocation
    private Location endPosition ; // End of the trip used for customer trips
    ...
    Trip(String tripID, String tripType, Location startPosition, String progress){
        this.tripID = tripID;
