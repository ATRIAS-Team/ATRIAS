...
import io.github.agentsoz.ees.jadexextension.masterthesis.RLDJL.ActionSpace;
import io.github.agentsoz.ees.jadexextension.masterthesis.RLDJL.RlAgent;
...
public class TrikeAgent implements SendtoMATSIM, RlAgent {
    ...
    //added djl oemer
    private float rewardDiscount = 0;
    ...
    public Integer selectNextAction(Integer position){
        ...
        if (decisionTaskList.get(position).getStatus().equals("new")){
            ...
            if (ownScore < commitThreshold && CNP_ACTIVE){
                ...
                String timeStampBooked = new SimpleDateFormat("HH.mm.ss.ms").format(new Date());
    ...
    public double getDrivingDistanceTo(Location location) throws AgentNotFoundException { // EUclician Distanz
        double dist =
                (double)SimActuator.getQueryPerceptInterface().
                        queryPercept(
