   ...
   // }
    ...
    void updateAtInputBroker(){
        ...
        for (Iterator<INotifyService2> iteration = service.iterator(); iteration.hasNext(); ) {
            ...
            System.out.println(" Newly active Agent " + agentID + "notifies" + currentSimInputBroker + " that it completed deliberating");
        }
    }
    ...
    void Status(){
        //if (agentID.equals("0")){
            ...
            //}
           //for (PerceptContent perceptContent : SimPerceptList) {
                //System.out.println("AgentID: " + agentID + " perceptType: "+ perceptContent.getPercept_type() + " parameters: " + perceptContent.getParameters());
           //}
        for (int i=0; i<decisionTaskList.size(); i++){
