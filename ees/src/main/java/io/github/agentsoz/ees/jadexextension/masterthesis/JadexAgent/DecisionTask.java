...
public class DecisionTask {
    ...
    //WaitingForManager
    private double timeStampWFM;
    //WaitingForProposal
    private double timeStampWFP;
    //WaitingForNeighbourlist
    private double timeStampWFN;
    //WaitingForConfirmations
    private double timeStampWFC;
    ...
    public double getTimeStampWFM() {
        return timeStampWFM;
    }

    public void setTimeStampWFM(double timeStamp) {
        this.timeStampWFM = timeStamp;
    }
    public double getTimeStampWFP() {
        return timeStampWFP;
    }

    public double getTimeStampWFN() {
        return timeStampWFN;
    }

    public void setTimeStampWFN(double timeStampWFN) {
        this.timeStampWFN = timeStampWFN;
    }

    public double getTimeStampWFC() {
        return timeStampWFC;
    }

    public void setTimeStampWFC(double timeStampWFC) {
        this.timeStampWFC = timeStampWFC;
    }

    public void setTimeStampWFP(double timeStampProposal) {
        this.timeStampWFP = timeStampProposal;
    }
